...
from .views import LotteryDataView, LotteryParticipantsView, BuyLotteryTicketView  # Import lottery views
...
urlpatterns = [
    ...
    # Lottery endpoints
    path("lottery/data/", LotteryDataView.as_view(), name="lottery_data"),
    path("lottery/participants/", LotteryParticipantsView.as_view(), name="lottery_participants"),
    path("lottery/buy-ticket/", BuyLotteryTicketView.as_view(), name="buy_lottery_ticket"),
